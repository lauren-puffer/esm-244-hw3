...
#NOW we can try an alternative method to see how much of the data is retained. If it would affect our analysis to do a 'list deletion', we will use the previous method for removing NAs

stream_clean <- stream_data |>
  drop_na()

#look at summary of the new data frame absent of NAs
...
##Create a summary dataframe with the mean values of each site. 
